...
// import { FETCH_SUCCESS, FETCH_ERROR, SET_FILTER } from "../reducer/actions";
...
//         fetchEvents();
//         fetchInterests();
//         fetchGroups(); // Make sure to fetch groups
//     }, []);

//     // Set Filter
//     const setFilter = (interest) => {
//         eventDispatch({ type: SET_FILTER, payload: interest });
//         groupDispatch({ type: SET_FILTER, payload: interest }); // Apply the same filter to groups
//     };
...
//         setFilter,
//         filteredEvents,
//         filteredGroups // Add filteredGroups
//     };
